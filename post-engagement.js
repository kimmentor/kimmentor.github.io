...
(function () {
  ...
  function listPageFor(slug){
    if(/^post-(saju|classic|modern|zwds|num|tarot)-\d/.test(slug)) return "fortune.html";
    if(slug==="post-launch"||slug==="post-how-i-built"||slug==="post-is-it-possible") return "index.html";
    return "tech.html";
  }
  function makePrevNext(){
    ...
    html+='<a class="pn-next'+(prev?'':' only')+'" href="'+(next?next+'.html':listPageFor(SLUG))+'">'+(next?'<span class="pn-l">다음 글 →</span><span class="pn-t">'+(TITLES[next]||next)+'</span>':'<span class="pn-l">목록 →</span><span class="pn-t">전체 글 보기</span>')+'</a>';
